...
public void bulkImport() {
        int c = 0;
        try (Scanner in = new Scanner(new FileReader("C:\\Training\\homecredit_javabootcamp\\assignments\\java\\bankingapp-with-collection - Copy\\src\\com\\homecredit\\bankingapp\\inAccounts.txt"))) {
...
//                this.create(a);
        ...
        public void bulkExport(){
                int c =0;
                try(FileWriter out = new FileWriter("C:\\Training\\homecredit_javabootcamp\\assignments\\java\\bankingapp-with-collection - Copy\\src\\com\\homecredit\\bankingapp\\outAccounts.txt")){
