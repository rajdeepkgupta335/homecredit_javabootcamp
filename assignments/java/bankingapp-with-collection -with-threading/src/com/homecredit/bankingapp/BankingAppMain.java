        ...
        do {
            ...
            switch (input) {
                ...
                case 5:
                    ...
                    break;
                case 6:
                    ((AccountServiceArrListImpl) accountService).PrintStatistics();
                    break;
                ...
                case 7:
                    Callable<Boolean> importThread = new Callable<Boolean>() {
                        ...
                        public Boolean call() throws Exception {
                            System.out.println(Thread.currentThread() + "\nWaiting 3sec to start import");
                            Thread.sleep(3000);
                            ((AccountServiceArrListImpl) accountService).bulkImport();
                            return true;
                        }
                    };
                ...
                case 8:
                    Callable<Boolean> exportThread = new Callable<Boolean>() {
                        @Override
                        public Boolean call() throws Exception {
                            System.out.println(Thread.currentThread() + "Waiting 3sec to start import");
                            Thread.sleep(3000);
                            ((AccountServiceArrListImpl) accountService).bulkExport();
                            return true;
                        }
                    };
